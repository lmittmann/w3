...
func TestBlockByHash__1(t *testing.T) {
	...
	if err := client.Call(eth.BlockByHash(w3.H("0x88e96d4537bea4d9c05d12549907b32561d3bf31f45aae734cdc119f13406cb6")).Returns(block)); err != nil {
...
func TestBlockByHash__46147(t *testing.T) {
	t.Parallel()
	...
	if err := client.Call(eth.BlockByHash(w3.H("0x4e3a3754410177e6937ef1f84bba68ea139e8d1a2258c5f85db9f1cd715a1bdd")).Returns(block)); err != nil {
		t.Fatalf("Request failed: %v", err)
	}
	if diff := cmp.Diff(wantBlock, block,
...
func TestHeaderByHash__12965000(t *testing.T) {
	t.Parallel()
	...
	if err := client.Call(eth.HeaderByHash(w3.H("0x9b83c12c69edb74f6c8dd5d052765c1adf940e320bd1291696e6fa07829eee71")).Returns(header)); err != nil {
		t.Fatalf("Request failed: %v", err)
	}
