...
func TestBlockByHash_1(t *testing.T) {
	t.Parallel()

	srv := rpctest.NewFileServer(t, "testdata/get_block_by_hash__1.golden")
	defer srv.Close()
	...
	if err := client.Call(
		eth.BlockByHash(w3.H("0x88e96d4537bea4d9c05d12549907b32561d3bf31f45aae734cdc119f13406cb6")).Returns(block),
	); err != nil {
...
func TestBlockByHash_RPCBlock_1(t *testing.T) {
	t.Parallel()
	...
	if err := client.Call(
		eth.BlockByHash(w3.H("0x88e96d4537bea4d9c05d12549907b32561d3bf31f45aae734cdc119f13406cb6")).ReturnsRAW(block),
	); err != nil {
		t.Fatalf("Request failed: %v", err)
	}
	if diff := cmp.Diff(wantBlock, block,
...
func TestBlockByHash_46147(t *testing.T) {
	t.Parallel()

	srv := rpctest.NewFileServer(t, "testdata/get_block_by_hash__46147.golden")
	defer srv.Close()
	...
	if err := client.Call(
		eth.BlockByHash(w3.H("0x4e3a3754410177e6937ef1f84bba68ea139e8d1a2258c5f85db9f1cd715a1bdd")).Returns(block),
	); err != nil {
		t.Fatalf("Request failed: %v", err)
	}
	if diff := cmp.Diff(wantBlock, block,
...
func TestBlockByHash_RPCBlock_46147(t *testing.T) {
	t.Parallel()
	...
	if err := client.Call(
		eth.BlockByHash(w3.H("0x4e3a3754410177e6937ef1f84bba68ea139e8d1a2258c5f85db9f1cd715a1bdd")).ReturnsRAW(block),
	); err != nil {
		t.Fatalf("Request failed: %v", err)
	}
	if diff := cmp.Diff(wantBlock, block,
...
func TestHeaderByHash_12965000(t *testing.T) {
	t.Parallel()

	srv := rpctest.NewFileServer(t, "testdata/get_block_by_hash__12965000.golden")
	defer srv.Close()
	...
	if err := client.Call(
		eth.HeaderByHash(w3.H("0x9b83c12c69edb74f6c8dd5d052765c1adf940e320bd1291696e6fa07829eee71")).Returns(header),
	); err != nil {
		t.Fatalf("Request failed: %v", err)
	}
...
func TestHeaderByHash_RPCHeader_12965000(t *testing.T) {
	t.Parallel()
	...
	var (
		header     = new(eth.RPCHeader)
		wantHeader = &eth.RPCHeader{
			Hash:        w3.H("0x9b83c12c69edb74f6c8dd5d052765c1adf940e320bd1291696e6fa07829eee71"),
			ParentHash:  w3.H("0x3de6bb3849a138e6ab0b83a3a00dc7433f1e83f7fd488e4bba78f2fe2631a633"),
			UncleHash:   w3.H("0x1dcc4de8dec75d7aab85b567b6ccd41ad312451b948a7413f0a142fd40d49347"),
			Coinbase:    w3.A("0x7777788200b672a42421017f65ede4fc759564c8"),
			Root:        w3.H("0x41cf6e8e60fd087d2b00360dc29e5bfb21959bce1f4c242fd1ad7c4da968eb87"),
	...
	if err := client.Call(
		eth.HeaderByHash(w3.H("0x9b83c12c69edb74f6c8dd5d052765c1adf940e320bd1291696e6fa07829eee71")).ReturnsRAW(header),
	); err != nil {
		t.Fatalf("Request failed: %v", err)
	}
	if diff := cmp.Diff(wantHeader, header,
		cmp.AllowUnexported(big.Int{}),
		cmpopts.IgnoreFields(eth.RPCHeader{}, "TransactionHashes"),
		cmpopts.EquateEmpty(),
	); diff != "" {
		t.Fatalf("(-want, +got)\n%s", diff)
	}
...
func TestBlockByHash_0x00(t *testing.T) {
	t.Parallel()
...
func TestBlockByHash_RPCBlock_0x00(t *testing.T) {
	t.Parallel()
	...
	if gotErr := client.Call(
		eth.BlockByHash(common.Hash{}).ReturnsRAW(block),
