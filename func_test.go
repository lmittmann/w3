...
func TestFuncDecodeArgs(t *testing.T) {
	...
	tests := []struct {
		...
		{
			Func:  MustNewFunc("test((address target, bytes data)[] calls)", ""),
			Input: B(""),
			Args:  []any{new([]tuple)},
			WantArgs: []any{
				[]tuple{
					{Arg0: A("0x1111111111111111111111111111111111111111"), Arg1: big.NewInt(7)},
