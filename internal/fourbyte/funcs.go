...
var functions = map[[4]byte]*w3.Func{
	...
	{0x48, 0xf5, 0xc3, 0xed}: w3.MustNewFunc("InvalidCaller()", ""),
	...
	{0x7a, 0x5e, 0xd7, 0x34}: w3.MustNewFunc("NotEnoughLiquidity(bytes32 poolId)", ""),
	...
	{0xa7, 0xab, 0xe2, 0xf7}: w3.MustNewFunc("ProtocolFeeTooLarge(uint24 fee)", ""),
	...
	{0xc7, 0x9e, 0x59, 0x48}: w3.MustNewFunc("ProtocolFeeCurrencySynced()", ""),
