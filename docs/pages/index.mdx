...
2. Create a signed transaction to the contract using [go-ethereum/core/types](https://pkg.go.dev/github.com/ethereum/go-ethereum/core/types).
...
### [`txpool`](https://pkg.go.dev/github.com/lmittmann/w3/module/debug)
